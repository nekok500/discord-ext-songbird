...
class QueueHandler:
    ...
    def swap_by_uuid(self, i: UUID, j: UUID) -> bool:
        ...

class IntoTrack:
    def __init__(self, source: AudioSource, volume: float, is_loop: bool, loop_count: Optional[int] = None, uuid: Optional[UUID] = None) -> None: ...
